...
CYDL_BEGIN_LIB_NAMESPACE
	...
	CYDL_BEGIN_LIB_DETAILS_NAMESPACE
		...
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_< DeviceTags::CPU, AllocPolicy > CYDL_FINAL
		{
		...
		template < template < typename > class AllocPolicy >
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_< DeviceTags::GPU, AllocPolicy > CYDL_FINAL
		{
		...
		template < template < typename > class AllocPolicy >
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_< DeviceTags::FPGA, AllocPolicy > CYDL_FINAL
		{
		...
		template <template <typename> class AllocPolicy>
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_<DeviceTags::TPU, AllocPolicy> CYDL_FINAL
		{
		...
		template <template <typename> class AllocPolicy>
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_<DeviceTags::DSP, AllocPolicy> CYDL_FINAL
		{
		...
		template <template <typename> class AllocPolicy>
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_<DeviceTags::ASIC, AllocPolicy> CYDL_FINAL
		{
		...
		template <template <typename> class AllocPolicy>
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_<DeviceTags::Neuromorphic, AllocPolicy> CYDL_FINAL
		{
		...
		template <template <typename> class AllocPolicy>
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_<DeviceTags::Quantum, AllocPolicy> CYDL_FINAL
		{
		...
		template <template <typename> class AllocPolicy>
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_<DeviceTags::IoT, AllocPolicy> CYDL_FINAL
		{
		...
		template <template <typename> class AllocPolicy>
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_<DeviceTags::Mobile, AllocPolicy> CYDL_FINAL
		{
		...
		template <template <typename> class AllocPolicy>
		struct CYDL_TEMPLATE_DEFAULT_CFLAG Allocator_<DeviceTags::Edge, AllocPolicy> CYDL_FINAL
		{
