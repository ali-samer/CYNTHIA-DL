...
#define CYDL_STRINGIFY_INTERNAL(X) #X

#define CYDL_STRINGIFY(X) CYDL_STRINGIFY_INTERNAL(X)
#define CYDL_TOSTRING(X) CYDL_STRINGIFY(X)
...
#define CYDL_COMPILE_TIME_ASSERT(expr, ...) static_assert(expr, "Assertion failed: " CYDL_TOSTRING(expr) ". " __VA_ARGS__)
...
#define CYDL_DEFAULT_BUFFER_SIZE 1024
#ifndef CYDL_BUFFER_SIZE
#   define CYDL_BUFFER_SIZE CYDL_DEFAULT_BUFFER_SIZE
#endif
